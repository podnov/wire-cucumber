...
public class DefaultMockInvocationsVerifier
	...
	protected DefaultMockInvocationsVerifier() {
	...
	public static DefaultMockInvocationsVerifier forRequestPattern(ScenarioContext context,
			String mockName,
			RequestPattern requestPattern) {
		DefaultMockInvocationsVerifier result = new DefaultMockInvocationsVerifier();
